...
const coffeeMachine = {
    ...
    fill: function () {
        this.water += parseInt(input('Write how many ml of water do you want to add:\n'))
        this.milk += parseInt(input('Write how many ml of milk do you want to add:\n'))
        this.beans += parseInt(input('Write how many grams of coffee beans do you want to add:\n'))
        this.cups += parseInt(input('Write how many disposable cups of coffee do you want to add:\n'))
    },
    take: function () {
...
while (coffeeMachine.option !== 'exit') {
    coffeeMachine.option = parseInt(input('Write action (buy, fill, take, remaining, exit):\n'))
